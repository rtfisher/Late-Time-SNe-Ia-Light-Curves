...
# Graur et al fit
ax.plot (times, lum55, label = '$^{55}$Fe/$^{57}$Co=1.2', linewidth = 2, color = 'green', linestyle = 'dotted')
ax.plot (times, lum56, label = '$^{56}$Co = 0.7 $M_{\odot}$', linewidth = 2, color ='blue', linestyle = 'dashed')
plt.plot (times, lum57, label = '$^{57}$Co/$^{56}$Co = 0.043', linewidth = 2, color = 'red', linestyle = 'dashdot')
